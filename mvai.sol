...
contract MVAI is Ownable, ReentrancyGuard, ERC20 {
    ...
    event TriggerStartTrading(uint256 blocktime, uint256 antiBotBlockEnd);
    ...
    constructor() ERC20("MoonVerseAI", "MVAI") {
        ...
        marketingWallet = 0x497ba4187ACF06E553B37D36A5E2891651C1eb98;
    ...
    function setBuyTax(
        ...
        require(
            _liquidityTaxBuy + _marketingTaxBuy + _reflectionTaxBuy <= 1_000,
    ...
    function setSellTax(
        ...
        require(
            _liquidityTaxSell + _marketingTaxSell + _reflectionTaxSell <= 1_000,
    ...
    function startTrading() external onlyOwner {
        ...
        emit TriggerStartTrading(block.number, antiBotBlockEnd);
    }
